"""Scrape Legend listings from Barnstormers.com and render them into
...
PAGE_TITLE = "Other Legend Ads on the Web"
...
EXTERNAL_SEARCH_LINKS = [
    ("Trade-A-Plane", "https://www.trade-a-plane.com/filtered/search?s-type=aircraft&s-keyword-search=legend+cub&s-original-search=legend+cub"),
    ("Controller", "https://www.controller.com/listings?keywords=legend+cub"),
    ("ASO", "https://aso.com/search?q=Legend+Cub"),
]
...
<body>
  ...
  <div class="more-resources">
    <h2>Search More Legend Listings</h2>
    <p>View additional Legend Aircraft listings at these fine sites:</p>
